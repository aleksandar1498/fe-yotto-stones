...
export default function BabylonScene() {
    ...
    return (
        <div className="w-full h-screen relative">
            ...
            {/* Bottom Icon Menu */}
            <div ref={menuRef} className="absolute bottom-[clamp(1rem,5vh,2rem)] left-1/2 transform -translate-x-1/2 bg-white rounded-xl px-6 py-3 shadow-md flex gap-6 z-[2001] items-center">
                {/* Finishing */}
