...
//           >
//             <h3 className="text-xl font-semibold text-gray-700 mb-4">ЕКСПРЕСНО ИЗПЪЛНЕНИЕ</h3>
...
//           >
//             <h3 className="text-xl font-semibold text-gray-700 mb-4">ВНИМАНИЕ КЪМ ДЕТАЙЛА</h3>
//             <p className="text-gray-500">
...
//           >
//             <h3 className="text-xl font-semibold text-gray-700 mb-4">ПРОФЕСИОНАЛНО КОНСУЛТИРАНЕ</h3>
//             <p className="text-gray-500">
//               Подкрепа от нашите експерти за най-добрите решения, съобразени с вашите нужди.
//             </p>
//           </motion.div>
//         </div>
//       </div>
...
import { motion } from 'framer-motion';
import { FaBolt, FaRegSmileBeam, FaPhoneAlt } from 'react-icons/fa';
